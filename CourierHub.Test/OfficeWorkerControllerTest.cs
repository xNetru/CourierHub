...
public class OfficeWorkerControllerTest {
    ...
    public async Task PatchEvaluation_ShouldAddEvaluation_WhenOfficeWorkerExistsAndEvaluationCorrect() {
        ...
        Assert.NotNull(order.EvaluationId);
        // TODO : problem with the mock
        //var evaluation = _mockContext.Object.Evaluations.FirstOrDefault(e => e.Id == order.EvaluationId);
        //Assert.NotNull(evaluation);
        //Assert.Equal(eval.Datetime, evaluation.Datetime);
        //Assert.Equal(eval.RejectionReason, evaluation.RejectionReason);
    }
}