...
namespace CourierHubWebApi.Validations
{
    public class CreateInquireWithEmailRequestValidator: AbstractValidator<CreateInquireWithEmailRequest>
    {
        ...
        public CreateInquireWithEmailRequestValidator(CreateInquireRequestValidator standardRequestValidator) 
        {
            _standardRequestValidator = standardRequestValidator;
